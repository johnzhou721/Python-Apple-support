...
build_time_vars = {
    ...
    'BLDSHARED': 'cc-macosx.x86_64 -dynamiclib -undefined dynamic_lookup -mios-version-min=14.0',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'CC': 'cc-macosx.x86_64',
    'CCSHARED': '',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0',
    'CFLAGSFORSHARED': '',
    ...
    'CONFIG_ARGS': "'AR=ar-macosx.x86_64' 'CC=cc-macosx.x86_64' 'CPP=cpp-macosx.x86_64' 'CXX=cxx-macosx.x86_64' 'CFLAGS=-mios-version-min=14.0' 'LDFLAGS=-mios-version-min=14.0' 'LIBLZMA_CFLAGS=-I/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/xz-5.4.4/include' 'LIBLZMA_LIBS=-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/xz-5.4.4/lib -llzma' 'BZIP2_CFLAGS=-I/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/bzip2-1.0.8/include' 'BZIP2_LIBS=-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/bzip2-1.0.8/lib -lbz2' 'LIBFFI_INCLUDEDIR=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/libffi-3.4.4/include' 'LIBFFI_LIBDIR=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/libffi-3.4.4/lib' 'LIBFFI_LIB=ffi' '--host=x86_64-apple-ios14.0' '--build=arm64-apple-darwin' '--with-build-python=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/macOS/macosx/python-3.13.0a1/bin/python3.13' '--prefix=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1' '--enable-ipv6' '--with-openssl=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/openssl-3.1.0' '--without-ensurepip' 'ac_cv_file__dev_ptmx=no' 'ac_cv_file__dev_ptc=no' 'build_alias=arm64-apple-darwin' 'host_alias=x86_64-apple-ios14.0'",
    ...
    'CXX': 'cxx-macosx.x86_64',
    'DEEPFREEZE_C': 'Python/deepfreeze/deepfreeze.c',
    'DEEPFREEZE_DEPS': './Tools/build/deepfreeze.py Include/internal/pycore_global_strings.h ./Programs/_freeze_module.py \\',
    'DESTDIRS': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1 /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/lib /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/lib/python3.13 /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/lib/python3.13/lib-dynload',
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-313-iphoneos.dylib',
    'FILEMODE': 644,
    'FLOAT_WORDS_BIGENDIAN': 0,
    'FREEZE_MODULE': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/macOS/macosx/python-3.13.0a1/bin/python3.13 ./Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/macOS/macosx/python-3.13.0a1/bin/python3.13 ./Programs/_freeze_module.py',
    ...
    'INCLDIRSTOMAKE': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/include /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/include /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/include/python3.13 /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/include/python3.13',
    ...
    'IO_OBJS': '\\',
    'LDCXXSHARED': 'cxx-macosx.x86_64 -dynamiclib -undefined dynamic_lookup',
    'LDFLAGS': '-mios-version-min=14.0',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'cc-macosx.x86_64 -dynamiclib -undefined dynamic_lookup -mios-version-min=14.0',
    'LDVERSION': '3.13',
    'LIBC': '',
    ...
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    'LIBHACL_CFLAGS': '-I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 -DHAVE_UINT128_T=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/lib/pkgconfig',
    'LIBPL': '/Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/iOS/macosx.x86_64/python-3.13.0a1/lib/python3.13/config-3.13-iphoneos-arm64',
    'LIBPYTHON': '',
    ...
    'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  _json  _lsprof  _opcode  _pickle  _queue  _random  _struct  _xxinterpchannels  _zoneinfo  math  cmath  _statistics  _datetime  _decimal  binascii  _bz2  _lzma  zlib  _dbm  _md5  _sha1  _sha2  _sha3  _blake2  pyexpat  _elementtree  _codecs_cn  _codecs_hk  _codecs_iso2022  _codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  unicodedata  fcntl  mmap  resource  select  _socket  termios  _sqlite3  _ssl  _hashlib  _uuid  xxsubtype  _xxtestfuzz  _testbuffer  _testinternalcapi  _testcapi  _testclinic  _testclinic_limited  _testimportmultiple  _testmultiphase  _testsinglephase  xxlimited  xxlimited_35  atexit  faulthandler  posix  _signal  _tracemalloc  _codecs  _collections  errno  _io  itertools  _sre  _sysconfig  _thread  time  _typing  _weakref  _abc  _functools  _locale  _operator  _stat  _symtable',
    'MODDISABLED_NAMES': '',
    'MODLIBS': '',
    ...
    'MODULE__BZ2_LDFLAGS': '-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/bzip2-1.0.8/lib -lbz2',
    ...
    'MODULE__HASHLIB_LDFLAGS': '-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/openssl-3.1.0/lib   -lcrypto',
    ...
    'MODULE__LZMA_CFLAGS': '-I/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/xz-5.4.4/include',
    'MODULE__LZMA_LDFLAGS': '-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/xz-5.4.4/lib -llzma',
    ...
    'MODULE__SSL_LDFLAGS': '-L/Users/johnzhou/Desktop/run/Python-Apple-support/macios/merge/iOS/macosx/openssl-3.1.0/lib  -lssl -lcrypto',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/Users/johnzhou/Desktop/run/Python-Apple-support/macios/build/iOS/macosx.x86_64/python-3.13.0a1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /Users/johnzhou/Desktop/run/Python-Apple-support/macios/build/iOS/macosx.x86_64/python-3.13.0a1/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__ios_iphoneos-arm64 /Users/johnzhou/Desktop/run/Python-Apple-support/macios/install/macOS/macosx/python-3.13.0a1/bin/python3.13',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include -DPy_BUILD_CORE',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -mios-version-min=14.0 -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I. -I./Include',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_HASH_ALGORITHM': 0,
    ...
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-313-iphoneos.dylib Modules/_asyncio.cpython-313-iphoneos.dylib Modules/_bisect.cpython-313-iphoneos.dylib Modules/_contextvars.cpython-313-iphoneos.dylib Modules/_csv.cpython-313-iphoneos.dylib Modules/_heapq.cpython-313-iphoneos.dylib Modules/_json.cpython-313-iphoneos.dylib Modules/_lsprof.cpython-313-iphoneos.dylib Modules/_opcode.cpython-313-iphoneos.dylib Modules/_pickle.cpython-313-iphoneos.dylib Modules/_queue.cpython-313-iphoneos.dylib Modules/_random.cpython-313-iphoneos.dylib Modules/_struct.cpython-313-iphoneos.dylib Modules/_xxinterpchannels.cpython-313-iphoneos.dylib Modules/_zoneinfo.cpython-313-iphoneos.dylib Modules/math.cpython-313-iphoneos.dylib Modules/cmath.cpython-313-iphoneos.dylib Modules/_statistics.cpython-313-iphoneos.dylib Modules/_datetime.cpython-313-iphoneos.dylib Modules/_decimal.cpython-313-iphoneos.dylib Modules/binascii.cpython-313-iphoneos.dylib Modules/_bz2.cpython-313-iphoneos.dylib Modules/_lzma.cpython-313-iphoneos.dylib Modules/zlib.cpython-313-iphoneos.dylib Mod